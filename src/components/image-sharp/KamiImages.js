    ...
    <StaticQuery
      query={graphql`
        query KamiImageQuery {
          kamiImage01: file(relativePath: { eq: "Kami_screencap_01.png" }) {
            childImageSharp {
              fluid(maxWidth: 1000) {
          ...
          kamiImage02: file(relativePath: { eq: "Kami_screencap_02.png" }) {
            childImageSharp {
              fluid(maxWidth: 1000) {
                ...GatsbyImageSharpFluid
              }
          ...
          kamiImage03: file(relativePath: { eq: "Kami_screencap_03.png" }) {
            childImageSharp {
              fluid(maxWidth: 1000) {
                ...GatsbyImageSharpFluid
              }
