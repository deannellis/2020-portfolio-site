  ...
  <Layout>
    ...
    <ProjectWrapper>
      ...
      <section>
        <h3>Background</h3>
        <p>
          Flext is a single-page application that I created to help users create
          and maintain a weight lifting routine. With this project, I wanted to
    ...
    <ProjectFooter>
      ...
      <div>
        ...
        <img src={placeholderImage1} alt="UPDATE DYNAMICALLY" />
      </div>
    </ProjectFooter>
  </Layout>
)
